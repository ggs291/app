  ...
  export default {
    ...
    methods: {
      ...
      async startMqttClient(){
        ...
        //Example topic: "userId/dId/variableId/sdata"
        ...
        try {
          ...
          console.log(error)
          console.log("Error al conectar MQTT")
          localStorage.clear()
        ...
        this.client.on('connect', () => {
          console.log("SERVER MQTT => SUCCESS")

          //SDATA SUBSCRIBE
          this.client.subscribe(deviceSubscribeTopic, {qos:0}, (err) => {
            if (err){
              console.log("Error Device Subscription")
              return
            }
          ...
          this.client.subscribe(notifSubscribeTopic, {qos:0}, (err) => {
            if (err){
              console.log("Error NotifSubscription")
              return
            }
        ...
        this.client.on('reconnect', (error) => {
            ...
            console.log("RECONNECTING SERVER MQTT: ", error)
            this.getMqttCredentialsForReconnection()
        })

        this.client.on('error', (error) => {
            console.log("SERVER MQTT CONNECTION FAIL => ERROR")
            console.log(error)
        })

        this.client.on('message', (topic, message) => {

          console.log("Message from mqtt " + topic + " => ")
