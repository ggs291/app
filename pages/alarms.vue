    ...
    <div>
        ...
        <div class="row">
            <div col-sm-12>
                <card v-if= "$store.state.devices.length > 0" >
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            ...
                            >
                                <el-option v-for="widget, index in $store.state.selectedDevice.template.widgets" 
                                :key="index" 
                                class="tex-dark"
                                :value="index"
                ...
                <card v-else>
                    You need to select a device to create Alarm
                </card>
                ...
                .then(res => {
                    if (res.data.status == "success") {
                        ...
                        this.$notify({
                            type: 'success',
                            icon: 'tim-icons icon-check-2',
                            message: 'Success! Alarm Rule was update'
                        })
            ...
            this.$axios.post("alarm-rule", toSend, axiosHeaders)
                ...
                .catch(e => {
                    this.$notify({
                        type: 'danger',
                        icon: 'tim-icons icon-alert-circle-exc',
                        message: 'Error, Alarm Rule not created'
                    })
                    console.log(e)
                    return
                })
